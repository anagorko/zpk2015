...
class Circle : public Figure
{
    ...
    virtual ostream& output(ostream& os) const {
        return os << "o srodku " << a << ", przechodzi przez" << b;
    }

public:
    Circle(Point p, Point r) {
        a = p;
        b = r;
    }

    virtual double area() {
        return a.distanceTo(b) *a.distanceTo(b)*3.14;
    }
...
class Line : public Figure
{
    ...
    virtual ostream& output(ostream& os) const {
        return os << "przechodzi przez punkt " << a << "oraz" << b;
    }
...
int main(int argc, char ** argv)
{
    ...
    Figure* h = new Circle(Point(0.0, 0.0),Point(0, 1.0));
   ...
   h -> scale(2);
    ...
    Figure* c = new Circle(Point(40.0, 50.0), Point(45.0,50.0));
