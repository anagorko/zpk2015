...
/*
Uzupelnic kod. 
Kryterium poprawnosci: dla punktów (1,0,0), (0,1,0), (0,0,1) wynikiem powinno byc 0.866025 (jest to trójkat równoboczny o boku dlugosci pierwiastek z dwóch).
*/
/* (wynik dla powyszych wartosci jest poprawny)*/
