...
display = al_create_display(w, h);
 ...
 // czesc glówna programu. Chce dowiedzieæ siê kto gra i czego od ¿ycia chce

        cout<<"Witam w programie"<<endl<<"Zadaniem jest trafic w cel lub w innego zawodnika"<<endl<<"Za ka¿de trafienie otrzymasz 1 punkt za trafienie w przeciwnika punktów 5"<<endl;
...
//wspólrzêdne srodka ukladu 200,200
